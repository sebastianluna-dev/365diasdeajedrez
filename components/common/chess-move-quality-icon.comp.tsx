...
function Svg({ className, children }: ChessMoveQualityIconVariantProps & { children: ReactNode }) {
  return (
    <svg className={className} viewBox="0 0 18 19" width="20" height="20" aria-hidden="true">
      {children}
    </svg>
  );
}

// Icons sourced directly from chess.com's move-quality badge set (viewBox 0 0 18 19).

function Good({ className }: ChessMoveQualityIconVariantProps) {
  return (
    <Svg className={className}>
      <path opacity="0.3" fill="#000" d="M9,.5a9,9,0,1,0,9,9A9,9,0,0,0,9,.5Z" />
...
function Inaccuracy({ className }: ChessMoveQualityIconVariantProps) {
  return (
    <Svg className={className}>
      <path opacity="0.3" fill="#000" d="M9,.5a9,9,0,1,0,9,9A9,9,0,0,0,9,.5Z" />
...
function Brilliant({ className }: ChessMoveQualityIconVariantProps) {
  return (
    <Svg className={className}>
      <path opacity="0.3" fill="#000" d="M9,.5a9,9,0,1,0,9,9A9,9,0,0,0,9,.5Z" />
...
function Blunder({ className }: ChessMoveQualityIconVariantProps) {
  return (
    <Svg className={className}>
      <path opacity="0.3" fill="#000" d="M9,.5a9,9,0,1,0,9,9A9,9,0,0,0,9,.5Z" />
      ...
      <path
        fill="#fff"
        d="M12.38,12.15H10.5l-.12,0a.34.34,0,0,0-.18.29v1.82a.36.36,0,0,0,.08.23.23.23,0,0,0,.1.07l.12,0h1.88a.24.24,0,0,0,.12,0,.26.26,0,0,0,.11-.07.36.36,0,0,0,.07-.1.28.28,0,0,0,0-.13V12.46a.27.27,0,0,0,0-.12.61.61,0,0,0-.07-.1A.32.32,0,0,0,12.38,12.15Z"
      />
      <path
        fill="#fff"
...
function Excellent({ className }: ChessMoveQualityIconVariantProps) {
  return (
    <Svg className={className}>
      <path opacity="0.3" fill="#000" d="M9,.5a9,9,0,1,0,9,9A9,9,0,0,0,9,.5Z" />
...
function Great({ className }: ChessMoveQualityIconVariantProps) {
  return (
    <Svg className={className}>
      <path opacity="0.3" fill="#000" d="M9,.5a9,9,0,1,0,9,9A9,9,0,0,0,9,.5Z" />
...
function Best({ className }: ChessMoveQualityIconVariantProps) {
  return (
    <Svg className={className}>
      <path opacity="0.3" fill="#000" d="M9,.5a9,9,0,1,0,9,9A9,9,0,0,0,9,.5Z" />
      <path fill="#81B64C" d="M9,0a9,9,0,1,0,9,9A9,9,0,0,0,9,0Z" />
...
function Mistake({ className }: ChessMoveQualityIconVariantProps) {
  return (
    <Svg className={className}>
      <path opacity="0.3" fill="#000" d="M9,.5a9,9,0,1,0,9,9A9,9,0,0,0,9,.5Z" />
...
function Book({ className }: ChessMoveQualityIconVariantProps) {
  return (
    <Svg className={className}>
      <path opacity="0.3" fill="#000" d="M9,.5a9,9,0,1,0,9,9A9,9,0,0,0,9,.5Z" />
      ...
      <path
        opacity="0.3"
        fill="#000"
        d="M8.45,5.9c-1-.75-2.51-1.09-4.83-1.09H2.54v8.71H3.62a8.16,8.16,0,0,1,4.83,1.17Z"
      />
      <path
        opacity="0.3"
        fill="#000"
        d="M9.54,14.69a8.14,8.14,0,0,1,4.84-1.17h1.08V4.81H14.38c-2.31,0-3.81.34-4.84,1.09Z"
      />
...
export const ChessMoveQualityIcon = {
  Best,
  Brilliant,
  Great,
  Excellent,
...
const QUALITY_TO_ICON: Record<MoveQuality, keyof typeof ChessMoveQualityIcon> = {
  best: "Best",
  brilliant: "Brilliant",
  great: "Great",
  excellent: "Excellent",
...
export function chessMoveQualityIconFor(quality: MoveQuality) {
  return ChessMoveQualityIcon[QUALITY_TO_ICON[quality]];
}
