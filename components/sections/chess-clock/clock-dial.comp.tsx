...
export function ClockDial({ label, time, hands, active, flagged, lowTime, onPress }: ClockDialProps) {
  return (
    <div className="clock-dial-column">
      <button
        type="button"
        onClick={onPress}
        className={`clock-dial${active ? " clock-dial_active" : ""}${flagged ? " clock-dial_fallen" : ""}`}
      >
