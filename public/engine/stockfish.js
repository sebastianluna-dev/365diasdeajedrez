 ...
 */ !(function () {
  ...
  function t() {
    function e(e) {
        ...
        L =
          (W
            ? ((p = l ? require("path").dirname(p) + "/" : __dirname + "/"),
              ...
              (n = function (e, n) {
                return (k(), (e = r.normalize(e)), H.readFileSync(e, n ? void 0 : "utf8"));
              }),
              ...
              (c = (e, n) => {
                ...
                (n instanceof Y || d("exiting due to exception: " + n), process.exit(e));
              }),
              (f.inspect = function () {
          ...
          l = {
            ...
            "%U": function (e) {
              ...
              return i(t, (e = new Date(e.A + 1900, e.K, e.L))) < 0
                ? a(
                    Math.ceil(
                      (31 - t.getDate() + (ye(M(e.getFullYear()) ? x : R, e.getMonth() - 1) - 31) + e.getDate()) / 7,
                    ),
                    2,
                  )
                : 0 === i(t, n)
            ...
            "%V": function (e) {
              ...
              return i(r, t) < 0
                ...
                : i(n, r) <= 0
                  ? "01"
                  : a(
                      Math.ceil((t.getFullYear() < e.A + 1900 ? e.O + 32 - t.getDate() : e.O + 1 - t.getDate()) / 7),
                      2,
                    );
            },
            "%w": function (e) {
            ...
            "%W": function (e) {
              var n = new Date(e.A, 0, 1),
                t = 1 === n.getDay() ? n : C(n, 0 === n.getDay() ? 1 : 7 - n.getDay() + 1);
              return i(t, (e = new Date(e.A + 1900, e.K, e.L))) < 0
                ? a(
                    Math.ceil(
                      (31 - t.getDate() + (ye(M(e.getFullYear()) ? x : R, e.getMonth() - 1) - 31) + e.getDate()) / 7,
                    ...
                    try {
                      ...
                      v ||
                        ...
                        O &&
                          1 === E &&
                          0 === T.length &&
                          ((E = 0), F(f._asyncify_stop_unwind), "undefined" != typeof Fibers) &&
                          Fibers.aa());
                    }
                  }
                : n;
      ...
      function De(e) {
        ...
        v ||
          (0 === E
            ? ((a = o = !1),
              e(() => {
                if (!v && ((o = !0), a)) {
                  ...
                  var e,
                    r = !1;
                  if ((O || ((e = be) && ((be = null), (n ? e.reject : e.resolve)(t), (r = !0))), n && !r)) throw t;
                }
              }),
              (a = !0),
              o ||
            ...
            : 2 === E
              ? ((E = 0), F(f._asyncify_stop_rewind), xe(O), (O = null), Se.forEach((e) => pe(e)))
              : A("invalid state: " + E));
      }
      var I,
        Me = {
          ...
          j: function (e, n, t) {
            ...
            for (fe.length = 0, t >>= 2; (r = y[n++]);)
              ((r = r < 105) && 1 & t && t++, fe.push(r ? N[t++ >> 1] : g[t]), ++t);
          ...
          n: function (r, o) {
            ...
            return (
              he().forEach(function (e, n) {
                var t = o + a;
                for (n = g[(r + 4 * n) >> 2] = t, t = 0; t < e.length; ++t) h[n++ >> 0] = e.charCodeAt(t);
          ...
          p: function (e, n, t, r) {
            for (var o = 0, a = 0; a < t; a++) {
              ...
              for (var s = 0; s < u; s++) {
                var c = y[i + s],
                  l = se[e];
                0 === c || 10 === c ? ((1 === e ? L : d)(X(l, 0)), (l.length = 0)) : l.push(c);
              }
              o += u;
            }
            return ((g[r >> 2] = o), 0);
          ...
          (!(function () {
            function n(e) {
              ((e = Ae((e = e.exports))),
                ...
                0 == b && (null !== re && (clearInterval(re), (re = null)), S) && ((e = S), (S = null), e()));
            }
            function t(e) {
              n(e.instance);
            }
            ...
            (i || "function" != typeof WebAssembly.instantiateStreaming || oe() || "function" != typeof fetch
              ? r(t)
      ...
      function Ie(a) {
        function e() {
          if (!I && ((I = !0), (f.calledRun = !0), !v)) {
            if ((D(Q), D(ee), j(f), f.onRuntimeInitialized && f.onRuntimeInitialized(), Ye)) {
              var e = a,
                n = f._main,
                t = (e = e || []).length + 1,
                r = P(4 * (t + 1));
      ...
      function Pe(e) {
        (m || 0 < _ || (te = !0), m || 0 < _ || (f.onExit && f.onExit(e), (v = !0)), c(e, new Y(e)));
      }
      if (
        ...
        (f.ccall = function (e, n, t, r, o) {
          function a(e) {
            return (--_, 0 !== s && Ee(s), "string" === n ? z(e) : "boolean" === n ? !!e : e);
          }
          var i = {
              string: function (e) {
                var n,
                  t = 0;
                return (null != e && 0 !== e && ((n = 1 + (e.length << 2)), (t = P(n)), G(e, y, t, n)), t);
              },
              array: function (e) {
                var n = P(e.length);
                return (h.set(e, n), n);
    ...
    var je;
    ((je = "undefined" != typeof document && document.currentScript ? document.currentScript.src : void 0),
  ...
  function o(e) {
    if (
      (c.ccall("command", null, ["string"], [e], { async: "undefined" != typeof IS_ASYNCIFY && /^go\b/.test(e) }),
      "quit" === e)
    ) {
      try {
        c.terminate();
  ...
  function i(e) {
    ("go" === (e = e.trim()).substring(0, 2) || "setoption" === e.substring(0, 9) ? n.push(e) : o(e), a());
  }
  function f() {
      ...
      r.length &&
        ...
        (function e() {
          for (var n; t < r.length;) {
            if ((n = r[t++]).startsWith("sleep ")) return setTimeout(e, n.slice(6));
            i(n);
          }
        })()));
  }
  function p(e, n, t) {
    ...
    return {
      ...
      eta: r,
      etaText: !(n = r) || n < 0 ? "" : n < 60 ? Math.ceil(n) + " sec" : Math.round(n / 60) + " min",
    };
  }
  function d(n) {
    var r, o;
      ...
      return fetch(e).then(function (e) {
        ...
        if (e.ok)
          return (
                ...
                !(function t() {
                  n.read()
                    .then(function (e) {
                      var n = e.done,
                        e = e.value;
                      n ? (u(i, o, o), r.close()) : ((a += e.byteLength), u(i, a, o), r.enqueue(e), t());
                    })
                    .catch(function e(n) {
                      (r.error(n), e(n));
                    });
            ...
            new Response(t, { status: e.status, statusText: e.statusText, headers: r })
          );
      ...
      return function (e, n, t) {
        s &&
          ...
          (r =
            r ||
            setTimeout(function () {
              ((r = null), s.postMessage(o), 1 <= o.percent && (s.close(), (s = null)));
            }, 4)));
      };
    }
    ((c = {
    ...
    ("undefined" != typeof global && "[object process]" === Object.prototype.toString.call(global.process))
      ? ((e = "undefined" != typeof global && "[object process]" === Object.prototype.toString.call(global.process)),
        ...
        e
          ? require.main === module
            ? ((e = require("path")),
              (u = e.join(__dirname, e.basename(__filename, e.extname(__filename)) + ".wasm")),
              (c = {
                locateFile: function (e) {
                  return -1 < e.indexOf(".wasm") ? (-1 < e.indexOf(".wasm.map") ? u + ".map" : u) : __filename;
                },
                listener: function (e) {
              ...
              require("readline")
                ...
                .on("line", function (e) {
                  e && (c.processCommand ? c.processCommand(e) : r.push(e), "quit" === e) && process.exit();
                })
                .on("close", function () {
                  process.exit();
                })
          ...
          : ((e = self.location.hash.substr(1).split(",")),
            ...
            (onmessage =
              ...
              function (e) {
                ...
                else if ((c.processCommand ? c.processCommand(e.data) : r.push(e.data), "quit" === e.data))
                  try {
                    self.close();
                  } catch (e) {}
              })))
